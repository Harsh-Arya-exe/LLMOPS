...
# Making the main app server application
...
static_dir = BASE_DIR / "static" # directory path for the static
template_dir = BASE_DIR / "templates" # directory path for the templated
#mounting the static path inside the FASTAPI
app.mount("/static", StaticFiles(directory=str(static_dir)), name="static")
#template for dynamic HTML
...
async def upload(files: List[UploadFile] = File(...)) -> UploadResponse:
    ...
    try:
        ...
        # Initialize empty session history for this session
        SESSIONS[session_id] = []
