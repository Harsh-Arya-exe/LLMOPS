...
from multi_doc_chat.logger.custom_logger import logger as log
from multi_doc_chat.exceptions.custom_exception import DocumentPortalException



class ApiKeyManager:
    REQUIRED_KEYS = ["GROQ_API_KEY", "GOOGLE_API_KEY", "HUGGINGFACEHUB_ACCESS_TOKEN"]
...
class ModelLoader:
    ...
    def load_embeddings(self):
        try:
            ...
            print(f"DEBUG → embedding model: {model_name}")
    ...
    def load_llm(self):
        ...
        if provider == "huggingface":
            llm = HuggingFaceEndpoint(
                repo_id=model_name,
                huggingfacehub_api_token=self.api_key_mgr.get('HUGGINGFACEHUB_ACCESS_TOKEN'),
